...
public class FileSystem : IFileSystem
{
	...
	public Ms.IDirectoryInfoFactory DirectoryInfo => _msFileSystem.DirectoryInfo;
	...
	public bool DeleteFileIfExists(string filePath) => _msFileSystem.File.Exists(filePath) && DeleteFile(filePath);
	...
	public string ExtractFileNameFromPath(string filePath){
		filePath.CheckArgumentNullOrWhiteSpace(nameof(filePath));
		FileInfo packageFileInfo = new FileInfo(filePath);
	...
	public void MoveFile(string oldFilePath, string newFilePath) => _msFileSystem.File.Move(oldFilePath, newFilePath);
	...
	public string ReadAllText(string filePath) => _msFileSystem.File.ReadAllText(filePath);
